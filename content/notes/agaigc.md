---
title: 当 AI 学会“完美伪装：《Adversarial Reality》
...
relations:
  - target: aigc-video-rethinking
    type: contrasts-with
    note: "从残差生成与检测规避构造攻击端，目标文章则把压缩、补帧和后处理攻击限定为鲁棒检测的防御性压力测试。"
---


*[Adversarial Reality for Evading Deepfake Image Detectors]*论文扮演了“白帽子黑客”的角色，用一种极其优雅且致命的攻击方式，无情地戳破了当前检测系统的虚假繁荣。

结合论文拆解以及我自己正在推进的“反取证”项目，记录一下这篇论文的核心亮点与实战启发。

---

### 一、 核心：“对抗性真实” (Adversarial Reality)
...
这篇论文的核心逻辑——**“冻结检测器，训练残差生成”**——为我正在推进的 AIGC 安全项目提供了完美的理论支撑。我抛弃了传统 GAN 容易崩溃的交替训练模式，梳理出了极其稳健的 **白盒对抗性生成** 落地计划。
